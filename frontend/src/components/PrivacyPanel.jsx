  ...
  return (
    <div className="space-y-4">
      <div className="card p-5">
        ...
        <button type="button" onClick={handleExport} disabled={loading} className="btn-secondary w-full sm:w-auto">
      ...
      <form onSubmit={handleErasureRequest} className="card p-5">
        ...
        <button type="submit" disabled={loading} className="btn-danger w-full sm:w-auto">
