-- 008_fix_flag_array_append.sql
-- Fix flag_reasons array building: use array_append instead of || with scalar
-- (scalar || on text[] was producing malformed array literals)
