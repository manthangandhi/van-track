...
-- 2. Create 3 users:
--    a) admin@vantrack.test (password: AdminPass123!) - role: admin
--    b) raj@vantrack.test (password: EmpPass123!) - role: employee
--    c) priya@vantrack.test (password: EmpPass123!) - role: employee
...
-- User UUID from priya@vantrack.test, role: employee
-- UPDATE public.profiles 
